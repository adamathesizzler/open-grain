# AGENTS.md — Instrucciones permanentes del proyecto OPEN GRAIN

Este archivo contiene reglas que Codex debe seguir SIEMPRE al trabajar en este repositorio, en cualquier sesión.

## Gestión de memoria y contexto

- Al comenzar cualquier conversación sobre este proyecto, lee primero `AGENTS.md` (este archivo) y `PROJECT_STATE.md`.
...
- Después de una compactación (o al retomar una sesión nueva), vuelve a leer `AGENTS.md`, `PROJECT_STATE.md` y el código relacionado antes de continuar trabajando.
...
- No guardes contraseñas, tokens, claves de API ni ninguna información sensible en `AGENTS.md` ni en `PROJECT_STATE.md`.
